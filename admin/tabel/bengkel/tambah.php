                    ...
                    ?>
                                    <form class="forms-sample" method="POST" action="prosesTambah.php"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Deskripsi_Bengkel" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_layanan" id="" class="form-control">
                                                ...
                                                ?>
                                                <option value="<?= $d['id_layanan'] ?>"> <?= $d['nama_layanan'] ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="operator" id="" class="form-control">
                                                ...
                                                ?>
                                                <option value="<?= $d['id_op'] ?>"> <?= $d['username'] ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        </div>
